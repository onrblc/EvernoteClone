...
namespace EvernoteClone.Entity.UserClasses
{
    public class User : BaseObject
    {
        ...
        [StringLength(50, MinimumLength = 5, ErrorMessage = "{0}, alanı en az {2}, en fazla {1} karakter olabilir.")]
        public string Name { get; set; }

        [DisplayName("Soyadı")]
        [Required(ErrorMessage = "{0} alanı boş bırakılamaz.")]
        [StringLength(50, MinimumLength =2, ErrorMessage = "{0}, alanı en fazla {2}, en az {1} karakter olabilir.")]
